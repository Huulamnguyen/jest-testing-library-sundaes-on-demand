...
test("order phases for happy path", async () => {
  ...
  // this one is async because this is a POST request in between server and confirmation pages
  ...
  //wait for the items to appear so that Testing Library doesn't get angry about what happening after test is over
  await screen.findByRole("spinbutton", { name: "Vanilla" });
  await screen.findByRole("checkbox", { name: "Chocolate" });
});
